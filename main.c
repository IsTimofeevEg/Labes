...
#include "libs/data_structures/matrix/matrix_16.h"
...
void test_for_fourthTask_1 () {
    int a[] = {35,23,53,245,2345,3245,23453,455,345};
    matrix m = createMatrixFromArray(&a, 3, 3);
    int b[] = {1249869,78855,94775,76688085,6981135,8742035,9023615,1763369,2838509};
    matrix q = createMatrixFromArray(&b, 3, 3);
    matrix h = fourthTask(m);
    for (int i = 0; i < m.nRows; i++) {
        for (int j = 0; j < m.nCols; j++) {
            assert(q.values[i][j] == h.values[i][j]);
        }
    }
}
